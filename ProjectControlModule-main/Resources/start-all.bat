...
start "Resource Backend" cmd /c "cd /d %~dp0resourceGrid\backend && npm run dev"
timeout /t 2 /nobreak >nul
start "Resource Frontend" cmd /c "cd /d %~dp0resourceGrid\frontend && set PORT=3001 && npm start"
